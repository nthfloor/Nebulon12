...
namespace BBN_Game.AI
{
    ...
    class Node:Marker
    {
        ...
        /// <summary>
        /// Temporary heuristic used by A*
        /// </summary>
        internal float heuristic;
        /// <summary>
        /// Temporary path cost used by A*
        /// </summary>
        internal double pathCost;
        /// <summary>
        /// Temporary flag for nodes that has been visited by A* already
        /// </summary>
        internal Boolean hasBeenVisited;
        /// <summary>
        /// Temporary edge used by A* to construct a path if one was found  
        /// </summary>
        internal Edge edgeToPrevNode;
        /// <summary>
        /// Method to clear temporary A* data stored in the node
        /// </summary>
        internal void clear()
        {
            heuristic = 0;
