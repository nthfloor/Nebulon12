...
namespace BBN_Game.ParticleEngine
{
    ...
    public abstract class ParticleSystem : DrawableGameComponent
    {
        ...
        public void DrawParticles(GameTime gameTime, Viewport vp)
        {
            ...
            drawCounter++;
            //device.Viewport = BBN_Game.Controller.GameController.Origional;
        }
        /// <summary>
        ...
        /// </summary>
        public void SetCamera(Matrix view, Matrix projection,Viewport vp)
        {
